...
#model
df = pd.read_csv(r'website\test-website\src\pages\api\music_data\features_3_sec.csv')
...
def find_sim(data):
    ...
    df_sim = pd.read_csv(r'website\test-website\src\pages\api\music_data\features_30_sec.csv')
